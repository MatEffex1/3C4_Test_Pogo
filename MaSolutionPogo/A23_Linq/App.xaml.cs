...
namespace A23_Linq
{
    ...
    public partial class App : Application
    {
        ...
        public class Player
        {
            ...
            public IEnumerable<Character> Characters => App.Characters.Values.Where(x => x.Id == Id);
        ...
        public class Character
        {
            ...
            public Player? Player => Players.Values.FirstOrDefault(x => x.Id == Id);

            // TODO: Faire un ToString()
            // Character ID_CHARACTER - NOM_CHARACTER - Player NOM_DU_PLAYER
            public override string ToString()
            {
                return $"Character {Id} - {Name} - {PlayerId}";
            }
        }
        ...
        public class Item
        {
            ...
            public Character? Character => Characters.Values.FirstOrDefault(x => x.Id == );
        ...
        public class Inventory
        {
            ...
            public Character? Character => Characters.Values.FirstOrDefault(x => x.Id == CharacterId);

            // TODO: Trouver tous les Items de l'inventory
            public IEnumerable<Item> Items => ItemIds.Select(x => App.Items[x]);

            // TODO: Faire un ToString()
            // Inventory ID_INVENTORY - Character NOM_CHARACTER - Contains NOMBRE_ITEMS items
            public override string ToString()
            {
                return $"Inventory {Id} - Character {Character} - Contains {Items.Count()} items";
            }
        }
    }
}
